...
if __name__ == '__main__':
    ...
    parser.add_argument('--tmchost',
                        help='FQDN or IP address of the TMC API')
    parser.add_argument('--tphost',
                        help='FQDN or IP address of the Tanzu Platform API')
    parser.add_argument('--spaces',
                        help='comma separated list of spaces to watch')
    parser.add_argument('--projectid',
                        help='id of the project to use')
    parser.add_argument('--manageddomains',help='comma separated list of domains that should be managed')
    parser.add_argument('--project',
                        help='name of the project')
    parser.add_argument('-u', '--user', help='NSX ALB API Username',
                        default='admin')
    parser.add_argument('-p', '--password', help='NSX ALB API Password')
    parser.add_argument('--csptoken', help='CSP token for api calls')
